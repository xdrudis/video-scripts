...
for dep in meson ninja git curl cmake; do
...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="$PREFIX" -DCMAKE_INSTALL_LIBDIR="$PREFIX"/lib -DUSE_OMP=OFF -DBUILD_SHARED_LIBS=OFF .
make
$sudo make install
rm -fR "$DIR"

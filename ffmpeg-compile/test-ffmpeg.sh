...
$PREFIX/bin/ffmpeg -i akiyo_qcif.y4m -vf "drawtext=text='text test':fontcolor=white:fontsize=24:box=1:boxcolor=black@0.5:boxborderw=5:x=20:y=20" output.mp4
if [[ "$HOSTTYPE" == x86_64 ]] ; then
   $PREFIX/bin/ffmpeg -i output.mp4 -i akiyo_qcif.y4m -lavfi "[0][1]libvmaf=model_path=$PREFIX/share/model/other_models/vmaf_v0.6.0.pkl" -f null -
fi
